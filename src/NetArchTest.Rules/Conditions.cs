namespace NetArchTest.Rules
{
    ...
    public sealed class Conditions
    {
        ...
        /// <returns>An updated set of conditions that can be applied to a list of types.</returns>
        public ConditionList HaveDependenciesOn(string[] dependencies)
        {
        ...
        /// <summary>
        /// Selects types that do not have a dependency on a list of types.
        /// </summary>
        /// <param name="dependencies">The dependency type to match against.</param>
        /// <returns>An updated set of conditions that can be applied to a list of types.</returns>
        public ConditionList NotHaveDependenciesOn(string[] dependencies)
        {
